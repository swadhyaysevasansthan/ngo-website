    ...
    return (
      <div>
        ...
        <input
          ...
          className={`w-full border rounded-lg px-4 py-3 outline-none transition ${errors[name]
                  ...
                  'primary'
                    ...
                    <section className="space-y-8">
                      ...
                      <div>
                        ...
                        <div
                          className={`mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold ${primaryCategoryTotal > 150
                  ...
                  'secondary'
                    ...
                    <section className="space-y-8">
                      ...
                      <div>
                        ...
                        <div
                          className={`mt-4 inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold ${secondaryCategoryTotal > 150
                            ? 'bg-red-100 text-red-700'
                            : secondaryCategoryTotal > 0
