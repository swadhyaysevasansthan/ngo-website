    ...
    },
    {
      ...
      details: (
        <div>
          ...
          <p>He hold 3 patents and more than 8 patents already published and are waiting for their grant.</p><br/>
...
export const patrons = [
  ...
  },
  {
    ...
    details: (
      <div>
        <p>Dr Madhu Ved is Dean and director at JPS Delhi. Author, TV panelist, life long learner, Aseas Bangkok Awardee.</p> <br/>
        <p>Life mantra- a dream for Green society that will lead to Vasudhav kutumkumb.</p>
      </div>
    ),
  },
  {
...
export const teamMembers = [
  ...
  },
  {
    ...
    description: "CMO at Samshudhi Naturopathy Hospital, 17+ yrs experience.",
    image: "/images/team/shalu-gupta.jpg",
    details: (
      <div>
        <p>PhD (Naturopathy and Yoga). She carries more than 17 years of work experience. </p><br/>
        <p>Chief Medical Officer – Samshudhi Residential Naturopathy and Panchakarma Hospital, Gurugram.</p>
      </div>
    ),
  },
  {
    ...
    role: "Yoga Expert",
    description: "National & international yoga gold medalist, referee.",
    image: "/images/team/user-nobg.png",
    details: (
      <div>
        <p>Referee Diploma from Asian Yoga Federation and Yoga Federation of India.</p><br/>
        <p> 4 times International Gold Medalist and 15 times National Gold Medalist.</p>
      </div>
    ),
  },
  {
    ...
    description: "Crystal Therapist, Atal Bharat Ratan Awardee.",
    image: "/images/team/shishir-pokhriyal.jpg",
    details: (
      <div>
        <p>Founder Shivaya Yog Sansthan and holistic health care.</p><br/>
        <p>Yoga Teacher Academic Counselor in IGNOU New Delhi.</p><br/>
        <p>18 years in Yoga, promotes holistic lifestyle in society.</p><br/>
        <p>MA Yogic Science, Pranic Healer, Crystal Therapy, Awarded Atal Bharat Ratan in field of Yoga 2022.</p>
      </div>
    ),
  },
  {
    ...
    description: "International Yoga Champion & Referee.",
    image: "/images/team/vijay-yadav.jpeg",
    details: (
      <div>
        <p>Masters in Yoga, Certified from MDNIY, YTTC 300 Hours (Mysore), 3× International Champion.</p><br/>
        <p>Three-time International Yoga Champion, International Yoga Teacher, and Certified International Yoga Referee.</p><br/>
        <p>Promotes yogic excellence and competitive yoga culture. Trains athletes and conducts global yoga workshops, blending ancient wisdom and modern practice.</p>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    description: "Dietician, international martial arts champion.",
    image: "/images/team/user-nobg.png",
    details: (
      <div>
        <p>Master in yoga, Bachelor of Naturopathy and Yoga, Diploma in Dietician health and nutrition.</p><br/>
        <p>2nd international all martial art championship trophy 2011, South Asian international karate championship.</p><br/>
      </div>
    ),
  },
  {
    ...
    description: "Bronze medalist, Delhi Olympiad.",
    image: "/images/team/user-nobg.png",
    details: (
      <div>
        <p>Bachelors of Yoga and Naturopathy, Masters in Yoga.</p><br/>
        <p> Bronze medalist in Delhi Olympiad.</p>
      </div>
    ),
  },
];
