      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed mb-4">
              Empowering lives through knowledge, service, and sustainable
              practices. Join us in creating a better tomorrow.
            </p>

            <div className="flex items-center space-x-2">
              <Heart size={16} className="text-red-500" />
              <span className="text-sm">
                Serving society since our inception
              </span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                />
                <span className="text-sm">
                  A-5/44, Pocket 5, Sector 18, Rohini, Delhi, 110089
                </span>
              </li>
              ...
              <li className="flex items-center space-x-3">
                ...
                />
                <span className="text-sm">
                  +91 95992 24323, 9837042298, 9810279323
                </span>
              </li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <div className="space-y-2">
            <p className="text-sm">
              © {new Date().getFullYear()} Swadhyay Seva Foundation. All rights
              reserved.
            </p>
          </div>
        </div>
